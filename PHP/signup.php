...
if ($conn->connect_error)
   ...
   //              if($_FILES['pic']['error'] > 0){
			...
			// }
			// echo $img;
			$sql = "INSERT INTO user_(first_name, last_name, nick_name, pass_word, user_email, phone_number, home_town, about_me, user_status, birth_date, user_gender, number_friends, user_image)VALUES('$firstname','$lastname','$nickname','$password','$email','$phone','$hometown','$aboutme','$mstatus','$birthdate','$gender', '$frnds', '')";
